...
export const stageResultDescriptions: Record<StageResult, StageResultDescription> = {
    [StageResult.Nothing]: {
    ...
    [StageResult.OnstageAndHarmony]: {
        ...
        localizedLongDescription: "The robot was onstage and in harmony during this stage.",
        num: 3,
    },
};
