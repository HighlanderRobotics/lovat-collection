...
const EXAMPLE_SCOUT_REPORT: ScoutReport = {
    ...
    "teamNumber": 3476,
    "events": [
        [0, 1, 5], [0, 8, 5], [2.991, 3, 2], [3.601, 0, 0], [4.535, 1, 9], [5.333, 3, 2], [7.501, 1, 14], [10.744, 3, 2], [12.365, 1, 8], [15.265, 3, 2], [16.165, 1, 10], [16.592, 3, 2], [30.086, 1, 0], [39.767, 3, 1], [48.89, 1, 0], [54.458, 3, 1], [59.577, 1, 0], [60.658, 3, 2], [61.238, 6, 0], [71.286, 7, 0], [77.185, 1, 0], [78.794, 3, 1], [89.164, 1, 0], [95.08, 3, 1], [99.253, 1, 0], [100.583, 2, 0], [102.218, 1, 0], [104.12, 3, 2], [105.836, 6, 0], [115.886, 7, 0], [125.171, 1, 0], [136.625, 3, 2], [147.056, 1, 0]
    ],
}
